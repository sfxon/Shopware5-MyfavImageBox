...
//{$smarty.block.parent}
Ext.define('Shopware.apps.Emotion.view.detail.elements.Myfavimagebox', {
     ...
     */
    alias: 'widget.detail-element-emotion-components-myfavimagebox',

    /**
     * You can define an additional CSS class which will be used for the grid element.
     */
    componentCls: 'emotion--myfavimagebox',
     ...
     */
        ...
        var me = this,
            preview = '',
            image = me.getConfigValue('myfavimagebox_thumbnail'),
            style;
