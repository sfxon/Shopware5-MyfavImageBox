// {namespace name="backend/emotion/myfavimage_box_element"}
//{block name="emotion_components/backend/myfavimagebox_myfavimagebox"}
Ext.define('Shopware.apps.Emotion.view.components.myfavimagebox', {
     ...
     */
    alias: 'widget.emotion-components-myfavimagebox',
